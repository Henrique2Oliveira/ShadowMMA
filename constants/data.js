...
export const combinationSets = [{
  ...
  "levels": {
    "beginner": [
      ...
      { "comboId": 6, "level": 1, "name": "Left Elbow", "moves": [
        { "move": "LEFT\nELBOW", "pauseTime": 1000, "direction": "left", "tiltValue": 0.5 }
      ]},
      { "comboId": 7, "level": 1, "name": "Right Elbow", "moves": [
        { "move": "RIGHT\nELBOW", "pauseTime": 1000, "direction": "right", "tiltValue": 0.5 }
      ]},
      { "comboId": 8, "level": 1, "name": "1-2 (Jab Cross)", "moves": [
        { "move": "JAB", "pauseTime": 1100, "direction": "left", "tiltValue": 0.3 },
        { "move": "CROSS", "pauseTime": 1100, "direction": "right", "tiltValue": 0.3 }
      ]},
      { "comboId": 9, "level": 1, "name": "Cross Jab (2-1)", "moves": [
        { "move": "CROSS", "pauseTime": 1100, "direction": "right", "tiltValue": 0.3 },
        { "move": "JAB", "pauseTime": 900, "direction": "left", "tiltValue": 0.4 }
      ]},
      { "comboId": 10, "level": 2, "name": "1-2-3", "moves": [
        { "move": "JAB", "pauseTime": 1000, "direction": "left", "tiltValue": 0.3 },
        { "move": "CROSS", "pauseTime": 1000, "direction": "right", "tiltValue": 0.3 },
        { "move": "LEFT\nHOOK", "pauseTime": 1300, "direction": "left", "tiltValue": 0.5 }
      ]},
      { "comboId": 11, "level": 3, "name": "Double Jab Cross", "moves": [
        { "move": "JAB", "pauseTime": 700, "direction": "left", "tiltValue": 0.2 },
        { "move": "JAB", "pauseTime": 800, "direction": "left", "tiltValue": 0.2 },
        { "move": "CROSS", "pauseTime": 1100, "direction": "right", "tiltValue": 0.3 }
      ]},
      { "comboId": 12, "level": 4, "name": "1-2-3-2", "moves": [
      ...
      { "comboId": 13, "level": 5, "name": "Jab Cross Uppercut", "moves": [
        { "move": "JAB", "pauseTime": 700, "direction": "left", "tiltValue": 0.2 },
