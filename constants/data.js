    ...
    "Punches": [
      ...
      },
      {
        "comboId": 7, "level": 1, "name": "Jab Body Cross", "moves": [
          ...
          { "move": "CROSS BODY", "pauseTime": 1100, "direction": "right", "tiltValue": 0.4 }
        ]
      },
      {
        "comboId": 8, "level": 1, "name": "Cross Body Jab", "moves": [
          { "move": "CROSS BODY", "pauseTime": 1000, "direction": "right", "tiltValue": 0.4 },
          { "move": "JAB", "pauseTime": 900, "direction": "left", "tiltValue": 0.3 }
        ]
      },
      {
        "comboId": 2, "level": 2, "name": "1-2-3", "moves": [
          ...
          { "move": "LEFT HOOK", "pauseTime": 1300, "direction": "left", "tiltValue": 0.5 }
        ]
      },
      {
      ...
      },
      {
        "comboId": 4, "level": 4, "name": "1-2-3-2", "moves": [
          ...
          { "move": "LEFT HOOK", "pauseTime": 1100, "direction": "left", "tiltValue": 0.4 },
          { "move": "CROSS", "pauseTime": 1100, "direction": "right", "tiltValue": 0.3 }
        ]
      },
      {
        "comboId": 5, "level": 5, "name": "Jab Cross Uppercut", "moves": [
          ...
          { "move": "RIGHT UPPERCUT", "pauseTime": 900, "direction": "up", "tiltValue": 0.6 }
        ]
      },
      {
      ...
      },
      {
        "comboId": 10, "level": 3, "name": "Head Body Head", "moves": [
          ...
          { "move": "CROSS BODY", "pauseTime": 900, "direction": "right", "tiltValue": 0.4 },
      ...
      },
      {
        "comboId": 12, "level": 5, "name": "Mixed Level Attack", "moves": [
          ...
          { "move": "CROSS BODY", "pauseTime": 900, "direction": "right", "tiltValue": 0.4 },
          { "move": "LEFT HOOK BODY", "pauseTime": 1000, "direction": "left", "tiltValue": 0.4 },
          { "move": "RIGHT UPPERCUT", "pauseTime": 1100, "direction": "up", "tiltValue": 0.5 }
        ]
      },
      {
    ...
    "Kicks": [
      {
        ...
        "name": "RIGHT Knee",
        "moves": [
          { "move": "RIGHT KNEE", "pauseTime": 1100, "direction": "up", "tiltValue": 0.6 }
        ]
      },
      {
        "comboId": 1,
        ...
        "name": "LEFT Knee",
        "moves": [
          { "move": "LEFT KNEE", "pauseTime": 1100, "direction": "up", "tiltValue": 0.6 }
        ]
      },
      {
        "comboId": 2,
        ...
        "name": "LEFT Low Kick",
        "moves": [
          { "move": "LEFT LOW KICK", "pauseTime": 1200, "direction": "up", "tiltValue": 0.5 }
        ]
      },
      {
        "comboId": 3,
        ...
        "name": "RIGHT Low Kick",
        "moves": [
          { "move": "RIGHT LOW KICK", "pauseTime": 1200, "direction": "up", "tiltValue": 0.5 }
        ]
      },
      {
        "comboId": 4,
        ...
        "name": "LEFT High Kick",
        "moves": [
          { "move": "LEFT HIGH KICK", "pauseTime": 1300, "direction": "up", "tiltValue": 0.7 }
        ]
      },
      {
        "comboId": 5,
        ...
        "moves": [
          { "move": "RIGHT HIGH KICK", "pauseTime": 1300, "direction": "up", "tiltValue": 0.7 }
        ]
      },
      {
        "comboId": 6,
        ...
        "name": "LEFT Push Kick",
        "moves": [
          { "move": "LEFT PUSH KICK", "pauseTime": 1100, "direction": "up", "tiltValue": 0.5 }
        ]
      },
      {
        "comboId": 7,
        ...
        "moves": [
          { "move": "RIGHT PUSH KICK", "pauseTime": 1100, "direction": "up", "tiltValue": 0.5 }
        ]
      },
    ],
    "Defense": [
